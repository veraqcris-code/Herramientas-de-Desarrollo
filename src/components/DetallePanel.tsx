      ...
      <div className="card-body p-4">
        ...
        <div className="d-flex justify-content-between align-items-start mb-3">
          ...
          <div className="text-end d-flex align-items-center gap-3">
            <i
              className={`bi ${iconoClima(ciudad.descripcion)}`}
              style={{ fontSize: '3.5rem', color: colorIcono(ciudad.descripcion) }}
            ></i>
            <div>
              <div
                className="fw-bold"
                style={{ fontSize: '3rem', color: '#61DAFB', fontFamily: 'monospace', lineHeight: 1 }}
              >
        ...
        <div className="d-flex justify-content-end mb-3">
          ...
          >
            <i
              className={`bi me-1 ${esFavorita ? 'bi-star-fill' : 'bi-star'}`}
              style={{ color: esFavorita ? '#61DAFB' : undefined }}
            ></i>
            ...
            <div key={i} className="col">
              <div className="card border-0 bg-light text-center">
                <div className="card-body py-2 px-1">
                  <div
                    className="text-muted"
                    style={{ fontSize: '0.65rem', textTransform: 'uppercase', fontFamily: 'monospace' }}
                  >
                    {d.dia}
                  </div>
                  <div className="fw-bold small" style={{ color: '#61DAFB', fontFamily: 'monospace' }}>
                    {d.max}°
                  </div>
